 ...
 */
class BasicToken : public contract
{
  public:
...
void add_abalance(account_name from,account_name sender, uint64_t value);
  ...
  */
   ...
   */
  bool approve(account_name _spender, uint64_t _value);
   ...
   */
  bool decreaseApproval(account_name _spender,uint64_t _subtractedValue);
 


};
 uint64_t BasicToken::totalSupply()
  {
    return totalSupply_;
  }