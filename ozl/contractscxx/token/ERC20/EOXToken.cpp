...
/**
   ...
   */
bool EOXToken::approve(account_name _spender, uint64_t _value)
{
...
/**
   ...
   */
bool EOXToken::increaseApproval(
    account_name _spender,
...
/**
   ...
   */
bool EOXToken::decreaseApproval(
    account_name _spender,
