...
/**
  ...
  */
void BasicToken::transfer(account_name _to, uint64_t _value)
{
...
void BasicToken::sub_balance(account_name owner, uint64_t value)
{
...
void BasicToken::add_balance(account_name owner, uint64_t value, account_name ram_payer)
{
...
/**
  ...
  */
uint64_t BasicToken::balanceOf(account_name _owner)
{
...
void BasicToken::sub_abalance(account_name from, account_name sender, uint64_t value)
{
...
/**
   ...
   */
bool BasicToken::approve(account_name _spender, uint64_t _value)
{
...
void BasicToken::add_abalance(account_name from, account_name sender, uint64_t value)
{
  allowed from_acnts(from, sender);
...
/**
   ...
   */
bool BasicToken::increaseApproval(
    account_name _spender,
...
/**
   ...
   */
bool BasicToken::decreaseApproval(
    account_name _spender,
