...
library AddressUtils {
   ...
   */
  function isContract(account_name _addr) internal view returns (bool) {
    uint256_t size;
    // XXX Currently there is no better way to check if there is a contract in an account_name
