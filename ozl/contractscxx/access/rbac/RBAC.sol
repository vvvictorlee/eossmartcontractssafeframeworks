...
contract RBAC {
   ...
   * // reverts
   */
  function checkRole(account_name _operator, string _role)
    public
    view
  {
   ...
   * @return bool
   */
  function hasRole(account_name _operator, string _role)
    public
    view
    returns (bool)
  {
   ...
   * @param _role the name of the role
   */
  function addRole(account_name _operator, string _role)
    internal
  {
   ...
   * @param _role the name of the role
   */
  function removeRole(account_name _operator, string _role)
    internal
  {
