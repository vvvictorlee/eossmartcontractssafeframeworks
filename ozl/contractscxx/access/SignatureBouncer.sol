...
contract SignatureBouncer is Ownable, RBAC {
   ...
   */
  function addBouncer(account_name _bouncer)
    public
    onlyOwner
  {
   ...
   */
  function removeBouncer(account_name _bouncer)
    public
    onlyOwner
  {
    eosio_assert(_bouncer != account_name(0));
   ...
   * @return bool
   */
  function isValidSignature(account_name _address, bytes _sig)
    internal
    view
    returns (bool)
  {
   ...
   * @return bool
   */
  function isValidSignatureAndMethod(account_name _address, bytes _sig)
    internal
    view
    returns (bool)
  {
  ...
  /**
    ...
    * @return bool
    */
  function isValidSignatureAndData(account_name _address, bytes _sig)
    internal
    view
    returns (bool)
  {
